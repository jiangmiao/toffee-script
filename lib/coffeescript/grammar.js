...
(function() {
  ...
  grammar = {
    ...
    Body: [
      ...
      o('Body TERMINATOR SimpleAssign',
      function() {
        return $1.push($3);
      }),
      o('Body TERMINATOR')
    ...
    Expression: [o('Value'), o('Code'), o('PromiseCode'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw'), o('Yield')],
    ...
    ExpressionLine: [o('CodeLine'), o('PromiseCodeLine'), o('IfLine'), o('OperationLine')],
    Yield: [
      o('YIELD',
      function() {
        return new Op($1,
    ...
    SimpleAssignableList: [
      o('SimpleAssignable , SimpleAssignable',
      function() {
        return [$1,
      $3];
      }),
      o('SimpleAssignableList , SimpleAssignable',
      function() {
        return $1.concat($3);
      })
    ],
    SimpleAssign: [
      o('SimpleAssignableList = Expression',
      function() {
        return new Assign(new Value(new Arr($1)),
      $3);
      })
    ],
    ...
    Invocation: [
      ...
      o('Value ASYNC OptFuncExist Arguments',
      function() {
        return new Op('await',
      new Call($1,
      $4,
