    ...
    class Return extends Base {
      ...
      compileNode(o) {
        ...
        if (this.expression) {
          ...
          unshiftAfterComments(answer, this.makeCode(`${this.tab}${rt}`));
...
// multiline need to be indented.
  ...
  exports.Code = Code = (function() {
    class Code extends Base {
      constructor(params, body, funcGlyph1, paramStart1) {
        var ref1;
        super();
        this.funcGlyph = funcGlyph1;
        this.paramStart = paramStart1;
        this.params = params || [];
  ...
  exports.PromiseBlock = PromiseBlock = class PromiseBlock extends Block {
    constructor(nodes) {
      super(nodes);
    }
  ...
  exports.PromiseCode = PromiseCode = class PromiseCode extends Code {
    constructor({params, body, funcGlyph, paramStart}) {
      body = new PromiseBlock([body]);
      super(params, Block.wrap([new Op("new", new Call(new Literal("Promise"), [new Code([new Param(new Literal("resolve")), new Param(new Literal("reject"))], body, new FuncGlyph("=>"), paramStart)]))]), funcGlyph, paramStart);
    }
