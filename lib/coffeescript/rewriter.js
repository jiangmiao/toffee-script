...
(function() {
  ...
  exports.Rewriter = Rewriter = (function() {
    class Rewriter {
      ...
      rewriteAsync() {
        var dest, line, ref, ref1, ref2, ref3, token, tokens;
        dest = [];
        ({tokens} = this);
        while (token = tokens.shift()) {
          if (((ref = token[0]) === 'IDENTIFIER' || ref === 'PROPERTY') && token[1].slice(-1) === '!') {
            line = token[2];
            token[1] = token[1].slice(0, -1);
            if ((ref1 = (ref2 = tokens[0]) != null ? ref2[0] : void 0) === '=' || ref1 === ':') {
              dest.push(token);
            ...
            if (((ref3 = tokens[0]) != null ? ref3[0] : void 0) !== 'CALL_START') {
