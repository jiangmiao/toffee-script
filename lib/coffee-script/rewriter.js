...
(function() {
  ...
  exports.Rewriter = (function() {
    ...
    Rewriter.prototype.rewriteAsync = function() {
      var dest, line, token, tokens, _ref, _ref1, _ref2, _ref3;
      dest = [];
      tokens = this.tokens;
      while (token = tokens.shift()) {
        if (((_ref = token[0]) === 'IDENTIFIER' || _ref === 'PROPERTY') && token[1].slice(-1) === '!') {
          line = token[2];
          token[1] = token[1].slice(0, -1);
          if ((_ref1 = (_ref2 = tokens[0]) != null ? _ref2[0] : void 0) === '=' || _ref1 === ':') {
            dest.push(token);
          ...
          if (((_ref3 = tokens[0]) != null ? _ref3[0] : void 0) !== 'CALL_START') {
